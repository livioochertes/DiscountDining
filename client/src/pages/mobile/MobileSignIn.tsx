          ...
          <div className="inline-flex items-center justify-center mb-4">
            <div className="bg-white rounded-2xl p-4 shadow-lg">
              <div className="flex items-center gap-1">
                <span className="text-3xl font-black text-teal-500">Eat</span>
                <span className="text-3xl font-black text-orange-500">Off</span>
              </div>
            </div>
          </div>
          <h2 className="text-2xl font-bold text-white mb-2">{t.welcomeBack || 'Bine ai revenit!'}</h2>
          <p className="text-teal-100">{t.connectToAccessAccount}</p>
        </div>

        <div className="flex-1 bg-white rounded-t-[32px] px-6 pt-8 pb-6 shadow-2xl">
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder={t.enterPassword || 'Introdu parola'}
            ...
            <div className="text-right">
              ...
              >
                {t.forgotPassword || 'Ai uitat parola?'}
              </button>
            </div>

            <Button 
              type="submit" 
              className="w-full h-14 text-base font-semibold rounded-xl bg-teal-500 hover:bg-teal-600 shadow-lg shadow-teal-500/30"
              disabled={isLoading}
            >
