...
>(({ className, children, onInteractOutside, ...props }, ref) => {
  ...
  const handleInteractOutside = (e: React.PointerEvent | React.FocusEvent | any) => {
...
// Simple fade-only overlay for clean close animation
const SimpleFadeOverlay = React.forwardRef<
  React.ElementRef<typeof DialogPrimitive.Overlay>,
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Overlay>
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
...
SimpleFadeOverlay.displayName = "SimpleFadeOverlay"

// Simple dialog content with only fade animation (no zoom/slide) for cleaner close
