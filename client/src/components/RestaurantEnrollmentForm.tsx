...
export default function RestaurantEnrollmentForm() {
  ...
  if (isSubmitted) {
    return (
      <div className="text-center py-12">
        ...
        <div className="bg-orange-50 dark:bg-orange-900/20 rounded-lg p-4 mb-6 max-w-md mx-auto">
          <h3 className="font-semibold text-orange-800 dark:text-orange-200 mb-2">What's Next?</h3>
          <ul className="text-left text-orange-700 dark:text-orange-300 space-y-1 text-sm">
