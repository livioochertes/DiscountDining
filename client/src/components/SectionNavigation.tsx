...
import { Users, Store, Settings, ShoppingCart, Award, CreditCard, BarChart3, UserCheck, Building2, Wallet, MessageCircle, Megaphone, Percent, Globe, ChefHat } from "lucide-react";
  ...
  const sections = [
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/admin", label: "Chefs", icon: ChefHat, tab: "chefs" },
        ...
        { href: "/admin", label: "Marketing", icon: Megaphone, tab: "marketing" },
        { href: "/admin", label: "Helpdesk", icon: MessageCircle, tab: "helpdesk" },
